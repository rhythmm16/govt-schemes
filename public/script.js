            ...
            <section class="container">
                ...
                <div class="about-section">
                    <div class="about-image">
                        <img src="/placeholder.svg?height=500&width=600" alt="About Women's Healthcare Initiatives">
                    </div>
                    <div class="about-content">
                        <h2>Empowering Women Through Healthcare Access</h2>
                        <p>Women's Healthcare Initiatives is a comprehensive resource platform dedicated to raising awareness about government schemes and programs for women's health in India.</p>
                        <p>Our mission is to bridge the information gap and ensure that every woman in India is aware of and can access the healthcare benefits provided by the government.</p>
                        <p>We collaborate with various government departments, healthcare professionals, and NGOs to provide accurate and up-to-date information about women's healthcare schemes.</p>
                    </div>
                </div>
                ...
                <div class="mission-vision">
                    <div class="mission">
                        <h3>Our Mission</h3>
                        <p>To empower women across India by providing comprehensive information about government healthcare schemes and facilitating access to these benefits, thereby improving the overall health and wellbeing of women in the country.</p>
                    </div>
                    <div class="vision">
                        <h3>Our Vision</h3>
                        <p>A future where every woman in India, regardless of her socioeconomic status or geographical location, has access to quality healthcare services and is aware of her healthcare rights and benefits.</p>
                    </div>
                </div>
                ...
                <div class="schemes-grid">
                    <div class="scheme-card">
                        <img src="/placeholder.svg?height=300&width=300" alt="Dr. Priya Sharma">
                        <div class="scheme-content">
                            <h3>Dr. Priya Sharma</h3>
                            <p>Founder & Director</p>
                            <p>Public Health Specialist with 15 years of experience in women's healthcare.</p>
                        </div>
                    </div>
                    
                    <div class="scheme-card">
                        <img src="/placeholder.svg?height=300&width=300" alt="Anita Desai">
                        <div class="scheme-content">
                            <h3>Anita Desai</h3>
                            <p>Program Coordinator</p>
                            <p>Social worker specializing in maternal and child health programs.</p>
                        </div>
                    </div>
                    
                    <div class="scheme-card">
                        <img src="/placeholder.svg?height=300&width=300" alt="Dr. Rajesh Kumar">
                        <div class="scheme-content">
                            <h3>Dr. Rajesh Kumar</h3>
                            <p>Medical Advisor</p>
                            <p>Gynecologist with expertise in reproductive health and family planning.</p>
                        </div>
                    </div>
                    
                    <div class="scheme-card">
                        <img src="/placeholder.svg?height=300&width=300" alt="Meera Patel">
                        <div class="scheme-content">
                            <h3>Meera Patel</h3>
                            <p>Outreach Specialist</p>
                            <p>Community health worker with experience in rural healthcare delivery.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="contact-container">
                    <div class="contact-info">
                        ...
                        <div class="contact-item">
                            ...
                            <div>
                                <h4>Address</h4>
                                <p>123 Healthcare Avenue, New Delhi - 110001, India</p>
                            </div>
                        </div>
                        ...
                        <div class="contact-item">
                            ...
                            <div>
                                <h4>Email</h4>
                                <p>info@womenshealthcare.org</p>
                                <p>support@womenshealthcare.org</p>
                            </div>
                        </div>
